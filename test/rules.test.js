...
test("Resolve non-marked request", t => {
    let resolve = RequestControl.resolveRequest(t.context.request, t.context.callback);
    t.falsy(resolve);
...
test("Request filtered - block sub_frame redirection", t => {
    ...
    RequestControl.markRequest(t.context.request, t.context.filterRule);
    let resolve = RequestControl.resolveRequest(t.context.request, function (request, action, updateTab) {
        t.true(updateTab);
