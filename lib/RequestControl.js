...
RequestControl.defaultOptions = {
    rules: [{
        ...
        description: "This filter rule prevents Google from obtaining the URL of clicked search link" +
        " via URL redirection. The tracking request done in background is classified as a Sub Document type." +
        " This rule provides an example of using the top-level domains pattern.",
        pattern: {
            scheme: "*",
            host: "*.google.*",
